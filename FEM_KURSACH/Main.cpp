...
double getIntegralG(int i, int j, const array<array<double, 3>, 4>& a, double det, triangle trig) {
    ...
    if (i == 0) {
        if (j == 0) {
            res += 16 * a[1][1] * a[1][1] * lll(2, 0, 0); //+ 16*L1**2*a11**2
            res += 16 * a[1][2] * a[1][2] * lll(2, 0, 0); //+ 16*L1**2*a12**2
            res -=  8 * a[1][1] * a[1][1] * lll(1, 0, 0); //-  8*L1*a11**2
            res -=  8 * a[1][2] * a[1][2] * lll(1, 0, 0); //-  8*L1*a12**2
            res +=      a[1][1] * a[1][1] * lll(0, 0, 0); //+       a11**2
            res +=      a[1][2] * a[1][2] * lll(0, 0, 0); //+       a12**2
            return res;
        }
        else if (j == 1) {
            res += 16 * a[1][1] * a[2][1] * lll(1, 1, 0); //+ 16*L1*L2*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(1, 1, 0); //+ 16*L1*L2*a12*a22
            res -=  4 * a[1][1] * a[2][1] * lll(1, 0, 0); //-  4*L1*a11*a21
            res -=  4 * a[1][2] * a[2][2] * lll(1, 0, 0); //-  4*L1*a12*a22
            res -=  4 * a[1][1] * a[2][1] * lll(0, 1, 0); //-  4*L2*a11*a21
            res -=  4 * a[1][2] * a[2][2] * lll(0, 1, 0); //-  4*L2*a12*a22
            res +=      a[1][1] * a[2][1] * lll(0, 0, 0); //+       a11*a21
            res +=      a[1][2] * a[2][2] * lll(0, 0, 0); //+       a12*a22
            return res;
        }
        else if (j == 2) {
            res += 16 * a[1][1] * a[3][1] * lll(1, 0, 1); //+ 16*L1*L3*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(1, 0, 1); //+ 16*L1*L3*a12*a32 
            res -=  4 * a[1][1] * a[3][1] * lll(1, 0, 0); //-  4*L1*a11*a31
            res -=  4 * a[1][2] * a[3][2] * lll(1, 0, 0); //-  4*L1*a12*a32
            res -=  4 * a[1][1] * a[3][1] * lll(0, 0, 1); //-  4*L3*a11*a31
            res -=  4 * a[1][2] * a[3][2] * lll(0, 0, 1); //-  4*L3*a12*a32
            res +=      a[1][1] * a[3][1] * lll(0, 0, 0); //+       a11*a31
            res +=      a[1][2] * a[3][2] * lll(0, 0, 0); //+       a12*a32
            return res;
        }
        else if (j == 3) {
            res += 16 * a[1][1] * a[2][1] * lll(2, 0, 0); //+ 16*L1**2*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(2, 0, 0); //+ 16*L1**2*a12*a22
            res += 16 * a[1][1] * a[1][1] * lll(1, 1, 0); //+ 16*L1*L2*a11**2
            res += 16 * a[1][2] * a[1][2] * lll(1, 1, 0); //+ 16*L1*L2*a12**2
            res -=  4 * a[1][1] * a[2][1] * lll(1, 0, 0); //-  4*L1*   a11*a21
            res -=  4 * a[1][2] * a[2][2] * lll(1, 0, 0); //-  4*L1*   a12*a22
            res -=  4 * a[1][1] * a[1][1] * lll(0, 1, 0); //-  4*L2*   a11**2
            res -=  4 * a[1][2] * a[1][2] * lll(0, 1, 0); //-  4*L2*   a12**2
            return res;
        }
        else if (j == 4) {
            res += 16 * a[1][1] * a[3][1] * lll(1, 1, 0); //+ 16*L1*L2*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(1, 1, 0); //+ 16*L1*L2*a12*a32
            res += 16 * a[1][1] * a[2][1] * lll(1, 0, 1); //+ 16*L1*L3*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(1, 0, 1); //+ 16*L1*L3*a12*a22
            res -=  4 * a[1][1] * a[3][1] * lll(0, 1, 0); //-  4*L2*   a11*a31
            res -=  4 * a[1][2] * a[3][2] * lll(0, 1, 0); //-  4*L2*   a12*a32
            res -=  4 * a[1][1] * a[2][1] * lll(0, 0, 1); //-  4*L3*   a11*a21
            res -=  4 * a[1][2] * a[2][2] * lll(0, 0, 1); //-  4*L3*   a12*a22
            return res;
        }
        else if (j == 5) {
            res += 16 * a[1][1] * a[3][1] * lll(2, 0, 0); //+ 16*L1**2*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(2, 0, 0); //+ 16*L1**2*a12*a32
            res += 16 * a[1][1] * a[1][1] * lll(1, 0, 1); //+ 16*L1*L3*a11**2
            res += 16 * a[1][2] * a[1][2] * lll(1, 0, 1); //+ 16*L1*L3*a12**2
            res -=  4 * a[1][1] * a[3][1] * lll(1, 0, 0); //-  4*L1*   a11*a31
            res -=  4 * a[1][2] * a[3][2] * lll(1, 0, 0); //-  4*L1*   a12*a32
            res -=  4 * a[1][1] * a[1][1] * lll(0, 0, 1); //-  4*L3*   a11**2
            res -=  4 * a[1][2] * a[1][2] * lll(0, 0, 1); //-  4*L3*   a12**2
            return res;
        }
    }
    else if (i == 1) {
        if (j == 1) {
            res += 16 * a[2][1] * a[2][1] * lll(0, 2, 0); //+ 16*L2**2*a21**2
            res += 16 * a[2][2] * a[2][2] * lll(0, 2, 0); //+ 16*L2**2*a22**2
            res -=  8 * a[2][1] * a[2][1] * lll(0, 1, 0); //-  8*L2*a21**2
            res -=  8 * a[2][2] * a[2][2] * lll(0, 1, 0); //-  8*L2*a22**2
            res +=      a[2][1] * a[2][1] * lll(0, 0, 0); //+       a21**2
            res +=      a[2][2] * a[2][2] * lll(0, 0, 0); //+       a22**2
            return res;
        }
        else if (j == 2) {
            res += 16 * a[2][1] * a[3][1] * lll(0, 1, 1); //+ 16*L2*L3*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(0, 1, 1); //+ 16*L2*L3*a22*a32
            res -=  4 * a[2][1] * a[3][1] * lll(0, 1, 0); //-  4*L2*   a21*a31
            res -=  4 * a[2][2] * a[3][2] * lll(0, 1, 0); //-  4*L2*   a22*a32
            res -=  4 * a[2][1] * a[3][1] * lll(0, 0, 1); //-  4*L3*   a21*a31
            res -=  4 * a[2][2] * a[3][2] * lll(0, 0, 1); //-  4*L3*   a22*a32
            res +=      a[2][1] * a[3][1] * lll(0, 0, 0); //+          a21*a31
            res +=      a[2][2] * a[3][2] * lll(0, 0, 0); //+          a22*a32
            return res;
        }
        else if (j == 3) {
            res += 16 * a[2][1] * a[2][1] * lll(1, 1, 0); //+ 16*L1*L2*a21**2
            res += 16 * a[2][2] * a[2][2] * lll(1, 1, 0); //+ 16*L1*L2*a22**2
            res -=  4 * a[2][1] * a[2][1] * lll(1, 0, 0); //-  4*L1*   a21**2
            res -=  4 * a[2][2] * a[2][2] * lll(1, 0, 0); //-  4*L1*   a22**2
            res += 16 * a[1][1] * a[2][1] * lll(0, 2, 0); //+ 16*L2**2*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(0, 2, 0); //+ 16*L2**2*a12*a22
            res -=  4 * a[1][1] * a[2][1] * lll(0, 1, 0); //-  4*L2*   a11*a21
            res -=  4 * a[1][2] * a[2][2] * lll(0, 1, 0); //-  4*L2*   a12*a22
            return res;
        }
        else if (j == 4) {
            res += 16 * a[2][1] * a[3][1] * lll(0, 2, 0); //+ 16*L2**2*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(0, 2, 0); //+ 16*L2**2*a22*a32
            res += 16 * a[2][1] * a[2][1] * lll(0, 1, 1); //+ 16*L2*L3*a21**2
            res += 16 * a[2][2] * a[2][2] * lll(0, 1, 1); //+ 16*L2*L3*a22**2
            res -=  4 * a[2][1] * a[3][1] * lll(0, 1, 0); //-  4*L2*   a21*a31
            res -=  4 * a[2][2] * a[3][2] * lll(0, 1, 0); //-  4*L2*   a22*a32
            res -=  4 * a[2][1] * a[2][1] * lll(0, 0, 1); //-  4*L3*   a21**2
            res -=  4 * a[2][2] * a[2][2] * lll(0, 0, 1); //-  4*L3*   a22**2
            return res;
        }
        else if (j == 5) {
            res += 16 * a[2][1] * a[3][1] * lll(1, 1, 0); //+ 16*L1*L2*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(1, 1, 0); //+ 16*L1*L2*a22*a32
            res -=  4 * a[2][1] * a[3][1] * lll(1, 0, 0); //-  4*L1*   a21*a31
            res -=  4 * a[2][2] * a[3][2] * lll(1, 0, 0); //-  4*L1*   a22*a32
            res += 16 * a[1][1] * a[2][1] * lll(0, 1, 1); //+ 16*L2*L3*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(0, 1, 1); //+ 16*L2*L3*a12*a22
            res -=  4 * a[1][1] * a[2][1] * lll(0, 0, 1); //-  4*L3*   a11*a21
            res -=  4 * a[1][2] * a[2][2] * lll(0, 0, 1); //-  4*L3*   a12*a22
            return res;
        }
        ...
        if (j == 2) {
            res += 16 * a[3][1] * a[3][1] * lll(0, 0, 2); //+ 16*L3**2*a31**2
            res += 16 * a[3][2] * a[3][2] * lll(0, 0, 2); //+ 16*L3**2*a32**2
            res -=  8 * a[3][1] * a[3][1] * lll(0, 0, 1); //-  8*L3*   a31**2
            res -=  8 * a[3][2] * a[3][2] * lll(0, 0, 1); //-  8*L3*   a32**2
            res +=      a[3][1] * a[3][1] * lll(0, 0, 0); //+          a31**2
            res +=      a[3][2] * a[3][2] * lll(0, 0, 0); //+          a32**2
            return res;
        }
        else if (j == 3) {
            res += 16 * a[2][1] * a[3][1] * lll(1, 0, 1); //+ 16*L1*L3*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(1, 0, 1); //+ 16*L1*L3*a22*a32
            res -=  4 * a[2][1] * a[3][1] * lll(1, 0, 0); //-  4*L1*   a21*a31
            res -=  4 * a[2][2] * a[3][2] * lll(1, 0, 0); //-  4*L1*   a22*a32
            res += 16 * a[1][1] * a[3][1] * lll(0, 1, 1); //+ 16*L2*L3*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(0, 1, 1); //+ 16*L2*L3*a12*a32
            res -=  4 * a[1][1] * a[3][1] * lll(0, 1, 0); //-  4*L2*   a11*a31
            res -=  4 * a[1][2] * a[3][2] * lll(0, 1, 0); //-  4*L2*   a12*a32
            return res;
        }
        else if (j == 4) {
            res += 16 * a[3][1] * a[3][1] * lll(0, 1, 1); //+ 16*L2*L3*a31**2
            res += 16 * a[3][2] * a[3][2] * lll(0, 1, 1); //+ 16*L2*L3*a32**2
            res -=  4 * a[3][1] * a[3][1] * lll(0, 1, 0); //-  4*L2*   a31**2
            res -=  4 * a[3][2] * a[3][2] * lll(0, 1, 0); //-  4*L2*   a32**2
            res += 16 * a[2][1] * a[3][1] * lll(0, 0, 2); //+ 16*L3**2*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(0, 0, 2); //+ 16*L3**2*a22*a32
            res -=  4 * a[2][1] * a[3][1] * lll(0, 0, 1); //-  4*L3*   a21*a31
            res -=  4 * a[2][2] * a[3][2] * lll(0, 0, 1); //-  4*L3*   a22*a32
            return res;
        }
        else if (j == 5) {
            res += 16 * a[3][1] * a[3][1] * lll(1, 0, 1); //+ 16*L1*L3*a31**2
            res += 16 * a[3][2] * a[3][2] * lll(1, 0, 1); //+ 16*L1*L3*a32**2
            res -=  4 * a[3][1] * a[3][1] * lll(1, 0, 0); //-  4*L1*   a31**2
            res -=  4 * a[3][2] * a[3][2] * lll(1, 0, 0); //-  4*L1*   a32**2
            res += 16 * a[1][1] * a[3][1] * lll(0, 0, 2); //+ 16*L3**2*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(0, 0, 2); //+ 16*L3**2*a12*a32
            res -=  4 * a[1][1] * a[3][1] * lll(0, 0, 1); //-  4*L3*   a11*a31
            res -=  4 * a[1][2] * a[3][2] * lll(0, 0, 1); //-  4*L3*   a12*a32
            return res;
        }
        ...
        if (j == 3) {
            res += 16 * a[2][1] * a[2][1] * lll(2, 0, 0); //+ 16*L1**2*a21**2
            res += 16 * a[2][2] * a[2][2] * lll(2, 0, 0); //+ 16*L1**2*a22**2
            res += 32 * a[1][1] * a[2][1] * lll(1, 1, 0); //+ 32*L1*L2*a11*a21
            res += 32 * a[1][2] * a[2][2] * lll(1, 1, 0); //+ 32*L1*L2*a12*a22
            res += 16 * a[1][1] * a[1][1] * lll(0, 2, 0); //+ 16*L2**2*a11**2
            res += 16 * a[1][2] * a[1][2] * lll(0, 2, 0); //+ 16*L2**2*a12**2
            return res;
        }
        else if (j == 4) {
            res += 16 * a[2][1] * a[3][1] * lll(1, 1, 0); //+ 16*L1*L2*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(1, 1, 0); //+ 16*L1*L2*a22*a32
            res += 16 * a[2][1] * a[2][1] * lll(1, 0, 1); //+ 16*L1*L3*a21**2
            res += 16 * a[2][2] * a[2][2] * lll(1, 0, 1); //+ 16*L1*L3*a22**2
            res += 16 * a[1][1] * a[3][1] * lll(0, 2, 0); //+ 16*L2**2*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(0, 2, 0); //+ 16*L2**2*a12*a32
            res += 16 * a[1][1] * a[2][1] * lll(0, 1, 1); //+ 16*L2*L3*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(0, 1, 1); //+ 16*L2*L3*a12*a22
            return res;
        }
        else if (j == 5) {
            res += 16 * a[2][1] * a[3][1] * lll(2, 0, 0); //+ 16*L1**2*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(2, 0, 0); //+ 16*L1**2*a22*a32
            res += 16 * a[1][1] * a[3][1] * lll(1, 1, 0); //+ 16*L1*L2*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(1, 1, 0); //+ 16*L1*L2*a12*a32
            res += 16 * a[1][1] * a[2][1] * lll(1, 0, 1); //+ 16*L1*L3*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(1, 0, 1); //+ 16*L1*L3*a12*a22
            res += 16 * a[1][1] * a[1][1] * lll(0, 1, 1); //+ 16*L2*L3*a11**2
            res += 16 * a[1][2] * a[1][2] * lll(0, 1, 1); //+ 16*L2*L3*a12**2
            return res;
        }
    }
    else if (i == 4) {
        if (j == 4) {
            res += 16 * a[3][1] * a[3][1] * lll(0, 2, 0); //+ 16*L2**2*a31**2
            res += 16 * a[3][2] * a[3][2] * lll(0, 2, 0); //+ 16*L2**2*a32**2
            res += 32 * a[2][1] * a[3][1] * lll(0, 1, 1); //+ 32*L2*L3*a21*a31
            res += 32 * a[2][2] * a[3][2] * lll(0, 1, 1); //+ 32*L2*L3*a22*a32
            res += 16 * a[2][1] * a[2][1] * lll(0, 0, 2); //+ 16*L3**2*a21**2
            res += 16 * a[2][2] * a[2][2] * lll(0, 0, 2); //+ 16*L3**2*a22**2
            return res;
        }
        if (j == 5) {
            res += 16 * a[3][1] * a[3][1] * lll(1, 1, 0); //+ 16*L1*L2*a31**2
            res += 16 * a[3][2] * a[3][2] * lll(1, 1, 0); //+ 16*L1*L2*a32**2
            res += 16 * a[2][1] * a[3][1] * lll(1, 0, 1); //+ 16*L1*L3*a21*a31
            res += 16 * a[2][2] * a[3][2] * lll(1, 0, 1); //+ 16*L1*L3*a22*a32
            res += 16 * a[1][1] * a[3][1] * lll(0, 1, 1); //+ 16*L2*L3*a11*a31
            res += 16 * a[1][2] * a[3][2] * lll(0, 1, 1); //+ 16*L2*L3*a12*a32
            res += 16 * a[1][1] * a[2][1] * lll(0, 0, 2); //+ 16*L3**2*a11*a21
            res += 16 * a[1][2] * a[2][2] * lll(0, 0, 2); //+ 16*L3**2*a12*a22
            return res;
        }
    }
    else if (i == 5) {
        if (j == 5) {
            res += 16 * a[3][1] * a[3][1] * lll(2, 0, 0); //+ 16*L1**2*a31**2
            res += 16 * a[3][2] * a[3][2] * lll(2, 0, 0); //+ 16*L1**2*a32**2
            res += 32 * a[1][1] * a[3][1] * lll(1, 0, 1); //+ 32*L1*L3*a11*a31
            res += 32 * a[1][2] * a[3][2] * lll(1, 0, 1); //+ 32*L1*L3*a12*a32
            res += 16 * a[1][1] * a[1][1] * lll(0, 0, 2); //+ 16*L3**2*a11**2
            res += 16 * a[1][2] * a[1][2] * lll(0, 0, 2); //+ 16*L3**2*a12**2
            return res;
        }
    }
...
double getIntegralM(int i, int j, double det, triangle trig) {
    double r1 = coord_input[trig.inds[0]].r;
    double r2 = coord_input[trig.inds[1]].r;
    double r3 = coord_input[trig.inds[2]].r;
    ...
    if (i == 0) {
        if (j == 0) {
            ...
            //4*L1**2*L2**2 - 2*L1**2*L2 - 2*L1*L2**2 + L1*L2
            res += 4 * lll(2, 2, 0);
            res -= 2 * lll(2, 1, 0);
            res -= 2 * lll(1, 2, 0);
            res += lll(1, 1, 0);
            ...
            //4*L1**2*L3**2 - 2*L1**2*L3 - 2*L1*L3**2 + L1*L3
            res += 4 * lll(2, 0, 2);
            res -= 2 * lll(2, 0, 1);
            res -= 2 * lll(1, 0, 2);
            res += lll(1, 0, 1);
        ...
        if (j == 1) {
            ...
            //4*L2**2*L3**2 - 2*L2**2*L3 - 2*L2*L3**2 + L2*L3
            res += 4 * lll(0, 2, 2);
            res -= 2 * lll(0, 2, 1);
            res -= 2 * lll(0, 1, 2);
            res += lll(0, 1, 1);
...
Matrix getLocalGFor(triangle loc_trig) {
    ...
    auto alpha = getAlpha(loc_trig);
    double det = abs(det_D(a, b, c));

    for (int i = 0; i < G.size(); i++) {
        for (int j = 0; j < G[i].size(); j++) {
            G[i][j] = diffusion_coef * getIntegralG(i, j, alpha, det, loc_trig);
        }
    }

#ifndef NDEBUG
    cout << "Индексы: ";
    for (int i = 0; i < loc_trig.inds.size(); i++) {
        cout << format("{:>3} ", loc_trig.inds[i]);
    }
    cout << endl;
    ...
    for (int i = 0; i < 6; i++) {
        double tmp = 0.0;
        for (int j = 0; j < 6; j++) {
            cout << format("{: .5f} + ", G[i][j]);
            tmp += G[i][j];
        }
        cout << " = " << (tmp > 5e-14 ? tmp : 0) << endl;
    }
    cout << "\n";
#endif // !NDEBUG
...
Matrix getLocalM(triangle loc_trig, double gamma = 1.0) {
    ...
    for (int i = 0; i < m.size(); i++) {
        for (int j = 0; j < m[i].size(); j++) {
            m[i][j] = gamma * getIntegralM(i, j, det, loc_trig);
        }
    }
    return m;
}
...
void addLocalToGlobal(triangle loc_trig, SparseMatrix& global_mat, Matrix& local_mat) {
    ...
    for (int i = 0; i < elems.size(); i++) {
        ...
        for (int j = 0; j < i; j++) {
            ...
            int id;
            for (id = global_mat.ig[ii]; id < global_mat.ig[ii + 1] && global_mat.jg[id] != jj; id++);
...
array<double, 6> getLocalbFor(triangle loc_trig, double t) {
    array<double, 6> vec_b = {};

    const auto& inds = loc_trig.inds;

    array<double, 6> funs = {};
    for (int i = 0; i < funs.size(); i++) {
        const auto& p = coord_input[inds[i]];
        funs[i] = f(loc_trig.omega, p.r, p.z, t);
    }
    const auto& C = getLocalM(loc_trig);
...
int main() {
    ...
    for (const auto& triangle : triangle_input) {
    ...
    for (int j = 2; j < timeGrid.size(); j++) {
        ...
        for (auto& triangle : triangle_input) {
            auto local_b_j = getLocalbFor(triangle, t_j);
            //cout << "Индексы: ";
            //for (const auto& i : triangle.inds) {
            //    cout << format("{:>3} ", i);
            //}
            //cout << endl << "Локальный вектор: ";
            //for (const auto& el : local_b_j) {
            //    cout << format("{: .5f} ", el);
            //}
            //cout << endl;
        ...
        for (int i = 0; i < layers[2].size(); i++) {
            ...
            cout << format("({: .3f};{: .3f}) {:>3}: {}\n", coord_input[i].r, coord_input[i].z, i, layers[2][i]);
        }
